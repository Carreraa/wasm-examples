...
async function initialize() {
  ...
  // Load WebDNN model
  // WebDNNモデルをロードします
  webdnn_runner = await WebDNN.load('./webdnn_graph_descriptor');/* FIXME */
  ...
  webdnn_input_view = webdnn_runner.getInputViews()[0];/* FIXME */
  webdnn_output_view = webdnn_runner.getOutputViews()[0];/* FIXME */
...
async function calculate() {
  ...
  var probabilities = webdnn_output_view.toActual()/* FIXME */;
