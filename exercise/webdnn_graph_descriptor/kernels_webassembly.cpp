...
float static_buffer[146088];
float* dynamic_buffer = nullptr;

int meta_buf_0[] = {145230,126026,1,1,28,28,26,26,3,3,1,1,1,1,0,0};
int meta_buf_1[] = {126026,0,137518,676,8,9};
int meta_buf_2[] = {72,137518,132110,8,8,8,676};
int meta_buf_3[] = {132110,75338,1,8,26,26,24,24,3,3,1,1,1,1,0,0};
int meta_buf_4[] = {75338,80,116810,576,16,72};
int meta_buf_5[] = {1232,116810,116810,16,16,16,576};
int meta_buf_6[] = {116810,142926,1,24,24,16,12,12,2,2,2,2,0,0};
int meta_buf_7[] = {142926,1248,146046,1,32,2304};
int meta_buf_8[] = {74976,146046,146014,32};
int meta_buf_9[] = {146014,75008,146078,1,10,32};
int meta_buf_10[] = {75328,146078,146078,10};
int meta_buf_11[] = {146078,146078,1,10};
...
extern "C" void init() {
    //static_buffer = (float*)malloc(146088 * sizeof(float));
}
